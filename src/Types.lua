...
export type Pseudo = {
    ...
    Replicate: (self:any)->nil??,
    GetFullName: (self:any)->string??,
    WaitForChild: (self:any,Name:string,onlyPseudo:boolean?,tries:number?)->Pseudo|Instance??,
    FindFirstAncestor: (self:any,Name:string,level:number?)->Pseudo|Instance??,
    FindFirstAncestorOfClass: (self:any,Name:string,level:number?)->Pseudo|Instance??,
    FindFirstAncestorWhichIsA: (self:any,Name:string,level:number?)->Pseudo|Instance??,
    FindFirstChild: (self:any,Name:string,recursive:boolean?,onlyPseudo:boolean?)->Pseudo|Instance??,
    FindFirstChildOfClass: (self:any,Name:string)->Pseudo|Instance??,
    FindFirstChildWhichIsA: (self:any,Name:string)->Pseudo|Instance??,
    GetDescendants: (self:any)->any??,
    GetChildren: (self:any,onlyPseudo:boolean?)->any??,
    SerializePropsAsync: (self:any)->string??,
    DeserializePropsAsync: (self:any,Serialized:string,Apply:boolean?)->any??,
    GET: (self:any,Target:string)->Pseudo|Instance|nil??,
    Clone: (self:any)->Pseudo??,
    Destroy: (self:any)->nil??,
    GetPropertyChangedSignal: (self:any)->PHeSignal<any>??,
    IsA: (self:any,ClassQuery:string)->boolean??,
    _GetAppModule: (self:any)->App??,
    _GetCompRef: (self:any)->Instance??,
    GetRef: (self:any)->Folder??,
    AddEventListener: (self:any,EventName:string,CreatingEvent:boolean?,BindCreateToEvent:BindableEvent?,SharedSignal:boolean?)->PHeSignal<nil>??,
    RemoveEventListener: (self:any,Events:string|any)->nil??,
    RemoveEventListeners: (self:any)->nil??,
    GetEventListener: (self:any)->PHeSignal<nil>??,
    _lockProperty: (self:any,propertyName:string,propertyCallback:any)->nil??,
    _lockProperties: (self:any,...string|any)->nil??,
    _unlockProperty: (self:any,...string|any)->nil??,
    _Render: (self:any) -> any??,
    -- _Render: (self:any)->{}|(Hooks:PseudoHooks)->any??,
    [any]: any?
}
...
export type AudioChannel = Pseudo&{
    AddAudio:(self:any,AudioName:string,AudioID:number,AudioVolume:number?,Looped:boolean?,PlayAudio:boolean?,Instant:boolean?,DeleteOnComplete:boolean?)->AudioChannelAudio,
...
export type ComputedPath = {
    ...
    Completed: PHeSignal,
    WaypointReached: PHeSignal<PathWaypoint,boolean>,
    Blocked: PHeSignal,
...
export type ArrayLibrary = {
    ...
    weighChances: (self:any,chanceIdentifierFunction:(key:any,value:any)->number??) -> (any,any),
    len: (self:any,dictionary:boolean?) -> number,
}
